...
const FirstScreen = ({ navigation }) => {
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#FFFFFF', alignSelf: 'center' }}>
            ...
            <Text style={{padding: 3, margin: 3, justifyContent: 'center', textAlign: 'center'}}>Cras ullamcorper massa sit amet augue vulputate, ac eleifend arcu scelerisque. Sed vestibulum lorem vitae lobortis euismod. Nullam id diam sit amet nisl sollicitudin viverra tincidunt sed metus. Maecenas sodales vestibulum urna, in egestas ipsum convallis sit amet.</Text>
            <MainButton title="Start learning" onPress={() => navigation.navigate('Log in')}>
